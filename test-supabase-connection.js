...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Iml0a3hmcW1zZ3JveXhkb2FsdnBoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njc1MzgxMzcsImV4cCI6MjA4MzExNDEzN30.XTkvG9MP-XZzsaH4D9FUbpa91TLOMDKsD3FP-SFLCE0'
...
console.log('   Chave (primeiros 50 chars):', supabaseKey.substring(0, 50) + '...')
...
Promise.race([
  ...
  .catch((error) => {
    ...
    console.log('   1. Verifique se o Supabase está acessível em https://app.supabase.com')
    console.log('   2. Confirme que as credenciais no .env estão corretas')
    console.log('   3. Verifique o status do Supabase em https://status.supabase.com')
    console.log('   4. Tente reiniciar o servidor de desenvolvimento')
    console.log('   5. Verifique se há um firewall/antivírus bloqueando a conexão')
  })
